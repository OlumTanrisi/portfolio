  ...
  return (
    <Section id="contact" className="contact-section">
      <Container>
        ...
        <div className="contact-actions"><Button href="mailto:hello@joao.dev" variant="primary">Fale comigo <ArrowUpRight size={16} /></Button><a className="contact-email" href="mailto:hello@joao.dev"><Mail size={17} strokeWidth={1.4} />hello@joao.dev</a></div>
